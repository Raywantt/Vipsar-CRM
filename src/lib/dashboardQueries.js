      ...
      applyPoolExclusion(
        supabase
          ...
          .select(
            ...
            'id, current_stage, quote_value, closure_probability, estimated_close_date, owner_employee_id, bdm_employee_id, parties!party_id(name), sites(nickname, locality, house_no), employees!owner_employee_id(name)',
            { count: 'exact' }
          )
